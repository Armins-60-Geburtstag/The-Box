...
const char *whoami = "Armins Funbox - Test Servos und Lichtschranke";
...
const int backtrack[] = {350, 350, 350, 350, 570};
...
void openSesam() {
  ...
  while ((adcValue = analogRead(LS)) < 35) {
    Serial.printf("ADC Value = %d\n", adcValue);
...
void closeSesam() {
  turnServo(5, 180, 500);   // ca. 180 deg ccw time controlled
  isSesamOpen = false;
}
